...
const Navbar = () => {
  ...
  return (
    <nav className="bg-blue-900 text-white shadow-lg fixed top-0 left-0 md:left-80 right-0 z-50 h-24 lg:h-28 flex items-center px-6 lg:px-6">
      <div className="relative w-72 lg:w-96 hidden md:block">
        <input
          type="text"
          placeholder="Search..."
          className="w-full p-3 lg:p-4 pl-12 text-black rounded-lg text-lg focus:outline-none"
        />
      </div>
      <div className="ml-auto flex items-center space-x-6 lg:space-x-8">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center space-x-3 bg-blue-800 px-5 py-3 rounded-lg hover:bg-blue-700 transition"
          >
          ...
          {dropdownOpen && (
            <div className="absolute right-0 mt-5 w-56 lg:w-64 bg-blue-800 text-white rounded-lg shadow-lg text-lg lg:text-xl">
              <button className="w-full flex items-center px-5 py-3 hover:bg-blue-700 transition">
                <CogIcon className="w-6 h-6 lg:w-7 lg:h-7 mr-3" /> My Account
              </button>
              <button className="w-full flex items-center px-5 py-3 hover:bg-blue-700 transition">
                <KeyIcon className="w-6 h-6 lg:w-7 lg:h-7 mr-3" /> Reset Password
              </button>
              <button className="w-full flex items-center px-5 py-3 text-red-500 hover:bg-red-700 transition">
